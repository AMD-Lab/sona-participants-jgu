...
link-citations: yes
github-repo:  AMD-Lab/sona-vp-jgu
lang: de
...
Dies ist das Sona-Handbuch für Versuchspersonen. Falls Sie Forscher\*in sind, gelangen Sie hier (Link) zum Sona-Handbuch für Forscher\*innen.
...
Nein, mit einem Versuchspersonen-Account können Sie selbst keine Studien einstellen. Um Studien bei Sona einstellen zu können, benötigen Sie einen Forschenden-Account. Diesen können nur Mitarbeiter\*innen des Psychologischen Instituts der JGU erhalten. Wenn dies auf Sie zutrifft, wenden Sie sich bitte an die Administration unter sona@uni-mainz.de. Diese wird Ihnen einen Forschenden-Account erstellen.
...
1.	Klicken Sie bitte zunächst auf folgenden Link: https://uni-mainz-jgu.sona-systems.com. 
...
3.	Auf der folgenden Seite finden Sie links eine Anleitung und rechts eine Spalte, in der Sie Ihre Nutzerdaten eintragen können. Welchen Benutzernamen Sie wählen, ist egal, da Sie diesen lediglich für die Anmeldung auf der Website benötigen. Der Benutzername und die E-Mail-Adresse dürfen noch nicht im System vorhanden sein. Falls Sie Psychologiestudierende\*r an der Johannes-Gutenberg-Universität Mainz sind, ist es sehr wichtig, dass Sie Ihre Universitäts-E-Mail-Adresse (endet auf \@students.uni-mainz.de) für die Anmeldung verwenden. Im Feld „Student ID“ geben Sie bitte Ihre Matrikelnummer an.
4.	Nach der Eingabe Ihrer Daten wird Ihnen zunächst ein Systempasswort per E-Mail zugesendet, das Sie nach Ihrer ersten Anmeldung in Sona ändern können. Diese E-Mail wird innerhalb weniger Minuten versandt. Bitte schauen Sie in ihrem Spam-Ordner nach, falls Sie die E-Mail nicht in Kürze erhalten.
...
Ihren Benutzernamen, Ihr Geburtsdatum sowie Ihre Student-ID (Matrikelnummer) können Sie nicht eigenständig ändern. Der genaue Wortlaut Ihres Benutzernamens ist nicht wichtig, da Sie diesen lediglich für den Login für die Website benötigen. Haben Sie allerdings einen Fehler bei der Eingabe Ihres Geburtsdatums oder Ihrer Student-ID (Matrikelnummer) gemacht, schreiben Sie bitte eine E-Mail an die Administration unter sona@uni-mainz.de, um die Daten ändern zu lassen. 
...
## Welche Art von Vergütung kann ich für die Teilnahme an einer Studie bekommen?
...
Die Anzahl der Versuchspersonen-Stunden (VP-Stunden), die Sie für die Teilnahme an einer Studie erhalten, entspricht der Dauer der Studie. Bei Laborstudien zählt die ggf. nötige Vorbereitung und Nachbereitung des Experiments, bei der Sie anwesend sein müssen, selbstverständlich zur Dauer dazu. Für die zusätzliche Zeit, die bei der An- und Abreise im Rahmen der Teilnahme an Laborstudien anfallen, werden Ihnen zudem zusätzlich 0,25 VP-Stunden Wegzeit gutgeschrieben. Da die kleinste Einheit einer VP-Stunde ein Viertel VP-Stunde (0,25) ist, wird im Zweifelsfall aufgerundet.

* Beispiel 1: Eine Online-Studie dauert 10 Minuten. Für die Teilnahme erhalten Sie 0,25 VP-Stunden. 
* Beispiel 2: Eine Laborstudie dauert 70 Minuten (1,25 VP-Stunden). Für die Wegzeit erhalten Sie zusätzlich 0,25 VP-Stunden. Somit erhalten Sie für die Teilnahme an dieser Studie insgesamt 1,5 VP-Stunden. 
...
## Wie übertrage ich E-Mail/Papier-Belege für VP-Stunden, die ich bereits gesammelt habe, auf mein Sona Konto?
...
3.	Senden Sie dieses <b>eine</b> PDF-Dokument mit dem <b>Betreff „VP-Stunden Anerkennung“</b> und unter der Angabe der folgenden Daten an sona@uni-mainz.de:
    * Name
    * Studiengang
    * Matrikelnummer 
    * Benutzername bei Sona

Die Administration wird Ihnen die VP-Stunden binnen eines Monats gutschreiben.  



## Wie reiche ich meine VP-Stunden beim Prüfungsamt ein?
...
4.	Bitte senden Sie diese PDF-Übersicht zusammen mit Ihrem <b>Namen, Studiengang und Ihrer Matrikelnummer</b> an Pruefungsamt-Psychologie@uni-mainz.de. 
